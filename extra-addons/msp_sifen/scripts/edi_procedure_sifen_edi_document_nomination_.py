# create_date: 2025-09-04 19:54:46.779293
# write_date: 2025-09-04 20:20:00.850156
# name: sifen.edi.document.nomination
# comment: OK. Crea un edi.event para nominar documentos
...
rgeseveinvalid = self.env['edi.template']._render("rGesEve_nomination",**vals)
